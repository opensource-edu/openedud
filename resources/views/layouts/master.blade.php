...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="/static/bootstrap/4.1.0/bootstrap.min.css">
    <link rel="stylesheet" href="/css/openedu.css">
    @yield("head")
    <title>Open EDU</title>
</head>
<body>
<header class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="#">OPENEDU</a>
        ...
        <div class="collapse navbar-collapse " id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="https://open-edu.cloud">OPEN EDU</a>
                </li>
            </ul>
        </div>
...
<script src="/static/jQuery/3.3.1-slim/jquery-3.3.1.slim.min.js"></script>
<script src="/static/popper.js/1.14.0/popper.min.js"></script>
<script src="/static/bootstrap/4.1.0/bootstrap.min.js"></script>
</body>
</html>
